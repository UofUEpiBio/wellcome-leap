...
This report summarizes the full production study for the two antibiotic-resistant organism scenarios. It uses 10,000 independent simulations per scenario with 1,000 agents per simulation.
...
The fixed 250-day safety horizon completed every higher-scenario run and 9,947 of 10,000 lower-scenario runs. Individual reproduction-number summaries exclude the 53 censored lower-scenario runs because some infectious agents remained active at the horizon. Infected agents with complete follow-up and zero secondary infections remain in the analysis.
